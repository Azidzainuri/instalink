...
$(function () {
    $.get("https://m.berinsta.com/onk/cek_provinsi.php", { prov_id: "" }).done(function (e) {
        var t = JSON.parse(e);
        ...
        $("#kabupaten").change(function () {
            ...
            $.ajax({
                type: "GET",
                url: "https://m.berinsta.com/onk/cek_kecamatan.php",
                data: "kab=" + kab,
                success: function (data) {
    ...
    $("#provinsi").change(function () {
        ...
        $.ajax({
            type: "GET",
            url: "https://m.berinsta.com/onk/cek_kabupaten.php",
            data: "prov_id=" + prov,
            success: function (data) {
                //jika data berhasil didapatkan, tampilkan ke dalam option select kabupaten
    ...
    $("#kurir").change(function () {
       ...
       $("#ongkos").html(cod);
                ...
                $.ajax({
                    type: "POST",
                    url: "https://m.berinsta.com/onk/cek_ongkir.php",
